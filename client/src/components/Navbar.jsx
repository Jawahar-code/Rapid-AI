...
const Navbar = () => {
    ...
    return (
        <div className='fixed z-50 w-full bg-primary/5 backdrop-blur-md border-b border-primary/20 flex justify-between items-center py-3 px-4 sm:px-20 xl-px:32'>
