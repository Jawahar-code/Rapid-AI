...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-white border border-gray-100">
            ...
            <p className="text-sm py-4 text-gray-800 text-left leading-relaxed">"{card.content}"</p>
    ...
    return (
        <section className="pt-10 pb-20 bg-white overflow-hidden text-center">
            <style>{`
            ...
            <div className="mb-14 px-4">
                <h2 className='text-slate-700 text-[42px] font-semibold mb-3 leading-tight'>Loved by Creators</h2>
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex overflow-hidden mb-8 relative">
                    <div className="absolute left-0 top-0 h-full w-20 md:w-32 z-10 pointer-events-none bg-linear-to-r from-white to-transparent"></div>
                    <div className="absolute right-0 top-0 h-full w-20 md:w-32 z-10 pointer-events-none bg-linear-to-l from-white to-transparent"></div>
