  ...
  return (
    <div className='h-full p-6 flex items-start flex-col lg:flex-row gap-6 text-slate-700 dark:text-slate-200 transition-colors overflow-hidden'>
      ...
      <form
        ...
        className='w-full lg:w-[40%] p-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm shrink-0 flex flex-col max-h-full overflow-y-auto custom-scrollbar'
      >
        ...
        <div className='mb-4'>
          ...
          <input
            ...
            placeholder='e.g., Complete Guide to Kubernetes Microservices'
        ...
        <div className='flex-1 flex flex-col mb-4 min-h-[180px]'>
          ...
          <textarea
            ...
            rows={10}
            placeholder='Paste your article, blog draft, landing page copy, or newsletter markdown here...'
            required
            ...
            <div className='flex gap-2 border-b border-slate-200 dark:border-slate-700 pb-2 shrink-0'>
              {tabs.map(({ id, label, Icon }) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-3.5 py-1.5 text-xs font-medium rounded-lg transition cursor-pointer ${
                    activeTab === id
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    {focusKeywordAnalysis.keyword ? (
                      <span className={`text-xs px-2.5 py-0.5 rounded-full font-medium ${
                        focusKeywordAnalysis.densityPercent >= 1 && focusKeywordAnalysis.densityPercent <= 2.5
